...
<div class="container mt-4">
	...
	if($_COOKIE['user'] == ''):
	 ?>
	<h1>Заполните форму, если вы еще не зарегестрированы или авторизуйтесь</h1>
	<div class="row">
		<div class="col">
			<form class="regform" action="checkreg.php" method="post">
		...
		<div class="col">
			<form class="regform" action="auth.php" method="post">
		<input type="text" class="form-control" name="login" id="login" placeholder="Введите логин"><br>
		<input type="text" class="form-control" name="pass" id="pass" placeholder="Введите пароль"><br>
